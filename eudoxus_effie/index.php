    ...
    <header>
      <div class="about_bar">
        <ul>
          ...
          <?php if (isset($_SESSION['userNickname'])) { echo '<li><a href="#">Προφίλ Χρήστη
            <ul>
              <li><a href="../subpages/edit.php">Επεξεργασία Στοιχείων</a></li>
              <li><a href="includes/logout.inc.php" name="logout-submit">Αποσύνδεση</a></li>
            </ul>
          </a></li> '; }
          else {
      ...
      <div class="below_about">
        ...
        <nav>
          <ul>
            ...
            <li><a href="subpages/publisher.php">Εκδότες</a></li>
        ...
        <div class="main_container">
          ...
          <div class="search_database">
            <h3>Βάση Συγγραμμάτων</h3>
              <form action="includes/BookSearch.inc.php" method="get" name="BookSearch">
