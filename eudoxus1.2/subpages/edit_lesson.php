...
?>
  <main>
      <div class="about_nav">
        <ul>
          <li class="current"><a href="secret_courses.php" >Πρόγραμμα Σπουδών</a>
      ...
      <form action="../includes/edit_lesson.inc.php" method="GET">
        <table id="t03">
            ...
            if($resultCheck > 0){
              ...
              ?>
                <tr>
                  ...
                  <td><a class="button_delete" href='../includes/delete_lesson.inc.php?id=<?php echo $row['Uni_lesson_id'] ?>'>Διαγραφή Μαθήματος</a></td>
                </tr>
              <?php
              }
            }
